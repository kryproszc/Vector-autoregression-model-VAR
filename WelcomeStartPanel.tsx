															...
															<div className="flex items-start justify-between gap-2">
																...
																{showIcon ? (
																			...
																			>
																				...
																				<span className="pointer-events-none absolute top-full left-0 z-50 mt-1 hidden w-80 max-w-[90vw] whitespace-pre-line rounded-md border border-slate-300 bg-white px-3 py-2 text-slate-700 text-sm leading-5 shadow-lg group-hover:block group-focus-within:block">
																					{tooltipText}
																				</span>
																			</span>
																) : null}
