...
export type TimeReportBreakdownValue = {
	leader: number | null;
	member: number | null;
...
export type TimeReportTrendRow = {
	...
	min: number | null;
	max: number | null;
	departmentMinTime: number | null;
	departmentMaxTime: number | null;
	count: number;
};
...
export type ReportsInspectionsTimeAnalyticsResponse = {
	...
	departmentMinTime: number | null;
	departmentMaxTime: number | null;
	departmentMinTimeByYear: Record<string, number | null>;
	departmentMaxTimeByYear: Record<string, number | null>;
	myCountByYear: Record<string, number | null>;
	baseCount: number;
	...
	myMetricByYearBreakdown: Record<string, TimeReportBreakdownValue>;
	myCountByYearBreakdown: Record<string, TimeReportBreakdownValue>;
	myMetricAllYearsBreakdown: TimeReportBreakdownValue | null;
	myCountAllYearsBreakdown: TimeReportBreakdownValue | null;
};
