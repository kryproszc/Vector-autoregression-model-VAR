...
> = {
	...
	rodzajPodmiotu: 210,
	dataProtokolu: 240,
	dataDoreczeniaProtokolu: 250,
	dataAkceptacjiSprawozdania: 250,
	dataDoreczeniaPisma: 240,
	dataPismaZastrzezenia: 240,
	dataWyslaniaPismaZZastrzezeniami: 270,
	dataWplywuPisma: 220,
	dataPismaZOdpowiedzia: 240,
	dataWyslaniaPismaZOdpowiedzia: 270,
	dataAkceptacjiNoty: 220,
	dataZalecen: 220,
	status: 190,
	komentarz: 240,
};
const INSPECTIONS_MIN_COLUMN_WIDTH = 210;
import type {
	InspectionColumnKey,
	InspectionRow,
	InspectionViewId,
...
export function InspectionsPanel({
	...
	const loadInspectionDictionaries = useCallback(async () => {
		...
		try {
			...
			setEntityNameOptions(resolveOptions(entityNamesResult));
			setInspectionTypeOptions(resolveOptions(inspectionTypesResult));
			setInspectionScopeOptions(
				normalizeInspectionScopeValues(resolveOptions(inspectionScopesResult)),
			);
			setMarketOptions(resolveOptions(marketsResult));
			setEntityTypeOptions(resolveOptions(entityTypesResult));
			setInspectionStatusOptions(resolveOptions(inspectionStatusesResult));
		} catch {
	...
	} = useInspectionsTableState({ inspectionRows });
		...
		const buildInspectionWritePayload = (
			...
			return {
				...
				dataPismaZastrzezenia: brakDataPismaZastrzezenia
					...
					: dataPismaZastrzezenia,
				brakDataPismaZastrzezenia,
				dataWyslaniaPismaZZastrzezeniami: toNullable(
				...
				dataPismaZOdpowiedzia: brakDataPismaZOdpowiedzia
					...
					: dataPismaZOdpowiedzia,
				brakDataPismaZOdpowiedzia,
				dataWyslaniaPismaZOdpowiedzia: toNullable(
	...
	return (
		...
		>
			...
			<InspectionsFormModal
				...
				editingInspectionCode={selectedInspectionRow?.kodInspekcji ?? null}
