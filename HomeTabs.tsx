...
export function HomeTabs() {
	...
	return (
		<div className="relative flex h-screen w-full overflow-hidden bg-[#09152b] text-slate-100">
			...
			<aside
				className={`fixed inset-y-0 left-0 z-30 flex h-screen w-80 flex-col border-[#2f4368] border-r bg-linear-to-b from-[#1d3053] via-[#192b49] to-[#14233e] p-5 shadow-[12px_0_28px_rgba(2,8,23,0.38)] transition-transform duration-300 lg:hidden ${
			...
			<div
				className={`hidden shrink-0 overflow-hidden transition-[width] duration-300 lg:block ${
					isDesktopSidebarExpanded ? "lg:w-60 xl:w-64" : "lg:w-20"
				}`}
			>
				{isDesktopSidebarExpanded ? (
					<aside className="flex h-screen w-60 flex-col border-[#2f4368] border-r bg-linear-to-b from-[#1d3053] via-[#192b49] to-[#14233e] px-3 py-4 shadow-[12px_0_28px_rgba(2,8,23,0.38)] xl:w-64 xl:px-4 xl:py-5">
						{sidebarContent}
					</aside>
				) : (
